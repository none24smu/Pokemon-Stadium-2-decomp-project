/*
 * Function: 0x801e43a8
 * ROM Offset: 0x000e53a8
 * Category: math
 * Auto-decompiled
 */

// Decompiled C code
int fcn.801e43a8 (int esi, int edx) {
if            // likely
// do {
// } while (?);
// } while (?);
...
int fcn.801e43a8 (int esi, int edx) {
    ...
    loc_0x801e43a8: // orphan
         if                       // unlikely
         

    loc_0x801e43b0: // orphan
