/*
 * Function: 0x8021f304
 * ROM Offset: 0x00120304
 * Category: math
 * Auto-decompiled
 */

// Decompiled C code
int fcn.8021f304 (int esi, int edx) {
// do {
if            // unlikely
// } while (?);
}
...
int fcn.8021f304 (int esi, int edx) {
    ...
    loc_0x80213a00: // orphan
         ...
         [sp + 0x34] = t4
         [sp + 0x18] = t6
         call 0x80045db4          // 0x80045db4(-1, 0x100, 0x1, 0x0)
         [sp + 0x38] = t5
         at = 0x4080 << 16
         mtc1 at, f12
         lwc1 f2, 0x10, s0
    ...
    loc_0x80214eb0: // orphan
         ...
         a2 = halfword [sp + 0x3c]
         a3 = halfword [sp + 0x3e]
         call 0x822056c0          // 0x822056c0(0x0, 0x0, 0x0, 0x1)
         [sp + 0x10] = t9
    ...
    loc_0x80215004: // orphan
         ...
         t2 = halfword [t1 + 2]
         t9 = 0x8221 << 16
         bnel v1, t2, 0x80215054  // unlikely
         t8 = [t5 + 0]
