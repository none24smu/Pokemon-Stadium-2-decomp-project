/*
 * Function: 0x802bacdc
 * ROM Offset: 0x001bbcdc
 * Category: math
 * Auto-decompiled
 */

// Decompiled C code
int fcn.802bacdc (int esi, int edx) {
// do {
if            // likely
// } while (?);
// } while (?);
...
int fcn.802bacdc (int esi, int edx) {
    ...
    loc_0x802bacdc: // orphan
         if                       // unlikely
         if                       // unlikely

    loc_0x802bace8: // orphan
    ...
    loc_0x802d6ec4: // orphan
         ...
         t8 = 0 + 0x400
         [sp + 0x1c] = t8
         call 0x80044270          // 0x80044270(0x1f00000, 0x0, 0x0, 0x0)
         a0 = , signed  a0 >> 0x10 // arg1

    loc_0x802d6f04: // orphan
         a0 = , signed  a0 >> 0x10 // arg1
    ...
    loc_0x802d71c8: // orphan
         call 0x80025f84          // 0x80025f84(0x0, 0x0, 0x0, 0x0)
         a0 += 0x68c0
         t7 = [sp + 0x50]
         bnel t7, 0, 0x802d722c   // unlikely
         t7 = [s0 + 0]
    ...
    loc_0x802d71dc: // orphan
         ...
         a0 = [s0 + 0]
         a3 = 0 + 0xf0
         call 0x8003573c          // 0x8003573c(0x37, 0xe6, 0xff, 0xf0)
         a0 += 0x129
         t3 = [s0 + 0]
         t2 = 0 + 2
         t4 = 0 + 3
    ...
    loc_0x802d722c: // orphan
         ...
         byte [t8 + 0x12e] = 0
         a0 = [s0 + 0]
         call 0x8003573c          // 0x8003573c(0x37, 0xdc, 0xdc, 0xb4)
         a0 += 0x129
         t0 = [s0 + 0]
         t9 = 0 + 0x47
         t1 = 0 + 0x48
    ...
    loc_0x802d726c: // orphan
         ...
         [sp + 0x14] = t3
         [sp + 0x10] = 0
         t4 = , unsigned  byte [v0 + 0x129]
         t0 = [sp + 0x64]
         t1 = , unsigned  byte [sp + 0x6f]
         [sp + 0x18] = t4
         t5 = , unsigned  byte [v0 + 0x12a]
         t7 = 0x8890 << 16
         t8 = 0x8890 << 16
         [sp + 0x1c] = t5
         t6 = , unsigned  byte [v0 + 0x12b]
         a2 += 0x9f
         a3 += 0x92
         a3 <<= 0x10
         a2 <<= 0x10
    ...
    loc_0x802d7340: // orphan
         ...
         [t9 + 0x130] = t0
         a0 = [s0 + 0]
         call 0x8000b580          // 0x8000b580(0x37, 0x0, 0x0, 0x0)
         a0 += 0x6c
         a1 = [s0 + 0]
         a0 = byte [sp + 0x5b]
         call 0x8005dc48          // 0x8005dc48(0x0, 0x37, 0x0, 0x0)
         a1 += 0x8c
         a0 = [sp + 0x50]
         a1 = [sp + 0x54]
         call 0x88902624          // 0x88902624(0x0, 0x0, 0x0, 0x0)
         a2 = byte [sp + 0x5b]
         t2 = [s0 + 0]
         t1 = 0 + 3
         at = 0 + 1
    ...
    loc_0x802d73bc: // orphan
         byte [t3 + 0x128] = 0
         t4 = [sp + 0x50]
         bnel t4, at, 0x802d73fc  // unlikely
         t8 = [sp + 0x50]

    loc_0x802d73cc: // orphan
         v0 = [s0 + 0]
         t5 = , unsigned  byte [v0 + 0x128]
         t7 = t5 | 1
         byte [v0 + 0x128] = t7
         a0 = [s0 + 0]
         a2 = byte [sp + 0x5b]
         a1 = [sp + 0x54]
         call 0x88902e4c          // 0x88902e4c(0x37, 0x0, 0x0, 0x0)
         a0 += 0x138
         t6 = [s0 + 0]
         byte [t6 + 0x13c] = v0
         t8 = [sp + 0x50]

    loc_0x802d73fc: // orphan
         at = 0 + 1
         t0 = [sp + 0x50]
         if                       // likely
         

    loc_0x802d740c: // orphan
         v0 = [s0 + 0]
         a1 = , unsigned  byte [v0 + 0x13c]
         if                       // unlikely
         

    loc_0x802d741c: // orphan
         call 0x88902c3c          // 0x88902c3c(0x0, 0x0, 0x0, 0x0)
         a0 = v0 + 0x9a
         call 0x88900638          // 0x88900638(0x9a, 0x0, 0x0, 0x0)
         
         goto 0x802d7510
         t7 = [s0 + 0]

    loc_0x802d7434: // orphan
         if                       // likely
         

    loc_0x802d743c: // orphan
         v0 = [s0 + 0]
         t9 = , unsigned  byte [v0 + 0x134]
         if                       // likely
         

    loc_0x802d744c: // orphan
         [v0 + 0x120] = 0
         t2 = [s0 + 0]
         t1 = 0 + 5
         ...
         t4 &= 0x78
         beql t4, 0, 0x802d74e8   // likely
         mfc1 t4, f16

    loc_0x802d74a0: // orphan
         mtc1 at, f16
         t4 = 0 + 1
         sub.s f16, f10, f16
         ctc1 t4, 31
    ...
    loc_0x802d74cc: // orphan
         mfc1 t4, f16
         at = 0x8000 << 16
         goto 0x802d74f4
         t4 |= at

    loc_0x802d74dc: // orphan
         goto 0x802d74f4
         t4 = 0 - 1

    loc_0x802d74e8: // orphan
         
         if                       // unlikely
         

    loc_0x802d74f4: // orphan
         t5 = [s0 + 0]
         ctc1 t3, 31
         goto 0x802d750c
         halfword [t5 + 0x13e] = t4

    loc_0x802d7504: // orphan
         call 0x8890055c          // 0x8890055c(0x0, 0x0, 0x0, 0x0)
         

    loc_0x802d750c: // orphan
         t7 = [s0 + 0]

    loc_0x802d7510: // orphan
         t6 = 0 + 1
         byte [t7 + 0x13d] = 0
         t8 = [s0 + 0]
         byte [t8 + 0x140] = t6
         ...
         halfword [t9 + 0x144] = 0
         t1 = [s0 + 0]
         call 0x88005048          // 0x88005048(0x0, 0x0, 0x0, 0x0)
         halfword [t1 + 0x146] = 0
         t2 = [s0 + 0]
         ra = [sp + 0x4c]
         s0 = [sp + 0x48]
         v0 = , unsigned  byte [t2 + 0x134]
         ret
         sp += 0x50
    ...
    loc_0x802d75f8: // orphan
         v1 = 0x8890 << 16
         v1 = , unsigned  byte [v1 + 0x41a0]

    loc_0x802d7600: // orphan
         t6 = [sp + 0x20]
         a1 = t6 + v1             // arg2
         byte [a1 + 2] = a0       // arg2
         call 0x80062e10          // 0x80062e10(0x0, 0xff, 0x0, 0x0)
         [sp + 0x18] = a1
         a1 = [sp + 0x18]
         byte [a1 + 0x18] = v0
         ra = [sp + 0x14]
    ...
    loc_0x802d7738: // orphan
         call 0x88902ba0          // 0x88902ba0(0x0, 0x0, 0x0, 0x0)
    ...
    loc_0x802d80a8: // orphan
         if                       // likely
         s1 = , signed  s1 >> 0x10

    loc_0x802d80b0: // orphan
         s0 = sp + 0x78
         s6 = 0 + 0xfc

    loc_0x802d80b8: // orphan
         t1 = [s4 + 8]
         t2 = t1 + s3
         s2 = , unsigned  byte [t2 + 2]
         if                       // likely
         s5 = s2

    loc_0x802d80cc: // orphan
         goto 0x802d80e0
         v1 = 0

    loc_0x802d80d4: // orphan
         call 0x80062d98          // 0x80062d98(0x0, 0x0, 0x0, 0x0)
         a0 = s2 & 0xff
         v1 = v0

    loc_0x802d80e0: // orphan
         a1 = v1 << 0x18
         a1 = , signed  a1 >> 0x18
         call 0x88000510          // 0x88000510(0x0, 0x0, 0x0, 0x0)
         a0 = sp + 0x74
         call 0x880006e0          // 0x880006e0(0x178074, 0x0, 0x0, 0x0)
         a0 = v0
         if                       // unlikely
         a0 = 0 + 0x45

    loc_0x802d8100: // orphan
         call 0x8004c874          // 0x8004c874(0x0, 0x0, 0x0, 0x0)
         a1 = 0 + 0x13
         goto 0x802d811c
         [s0 + 0] = v0

    loc_0x802d8110: // orphan
         call 0x80062ce0          // 0x80062ce0(0x0, 0x0, 0x0, 0x0)
         a0 = s2 & 0xff
         [s0 + 0] = v0

    loc_0x802d811c: // orphan
         a1 = halfword [s4 + 4]
         a0 = 0x8800 << 16
         a3 = [s0 + 0]
         t3 = 0 + 1
         ...
         a0 = [a0 + 0x687c]
         a2 = s1
         call 0x80048e30          // 0x80048e30(-1, 0xffff, 0x0, 0x0)
         a1 += 0x162
         t4 = , unsigned  byte [s4 + 0xe]
         s3 += 1
         s1 += 0x1a
         s1 <<= 0x10
         at = , unsigned  , s3 < t4
    ...
    loc_0x802d8160: // orphan
         s3 = 0

    loc_0x802d8164: // orphan
         a0 = 0x8800 << 16
         s6 = 0 + 0xfc
         ...
         halfword [sp + 0x70] = a1
         a0 = [a0 + 0x687c]
         call 0x80048e30          // 0x80048e30(-1, 0xffff0161, 0xffff010a, 0x0)
         a3 = [sp + 0x88]
         t6 = [s4 + 8]
         t7 = halfword [s4 + 0xc]
         t8 = t6 + t7
         s2 = , unsigned  byte [t8 + 2]
         if                       // unlikely
         s5 = s2

    loc_0x802d81d8: // orphan
         call 0x80062d5c          // "&1" // 0x80062d5c(0x0, 0x0, 0x0, 0x0)
         a0 = s2 & 0xff
         s1 += 0x14
         s1 <<= 0x10
         s0 = v0 & 0xff
    ...
    loc_0x802d81f4: // orphan
         t9 = v0 & 0xff
         at = 0 + 1
         if                       // likely
         a0 = 0 + 0x45

    loc_0x802d8204: // orphan
         a0 = 0 + 0x45
         call 0x8004c874          // 0x8004c874(0x45, 0x0, 0x0, 0x0)
         a1 = 0 + 3
         a0 = 0 + 0x45
         a1 = 0 + 5
         call 0x8004c874          // 0x8004c874(0x45, 0x5, 0x0, 0x0)
         [sp + 0x60] = v0
         v1 = [sp + 0x60]
         a3 = 0x8890 << 16
         a3 += 0x4170
         ...
         a2 = 0
         [sp + 0x14] = v0
         call 0x800495f8          // 0x800495f8(0x161, 0x0, 0x0, 0x88904170)

    loc_0x802d8240: // orphan
         [sp + 0x10] = v1
         goto 0x802d8278
         s1 += 0x14

    loc_0x802d824c: // orphan
         call 0x8004c874          // 0x8004c874(0x0, 0x0, 0x0, 0x0)
         a1 = 0 + 3
         a3 = 0x8890 << 16
         a3 += 0x4178
         ...
         a2 = 0
         [sp + 0x10] = v0
         call 0x800495f8          // "&1" // 0x800495f8(0x161, 0x0, 0x0, 0x88904178)
         [sp + 0x14] = s0
         s1 += 0x14

    loc_0x802d8278: // orphan
         s1 <<= 0x10
         s1 = , signed  s1 >> 0x10
         a0 = 0 + 0x45
         call 0x8004c874          // 0x8004c874(0x45, 0x0, 0x0, 0x0)
         a1 = 0 + 4
         [sp + 0x64] = v0
         call 0x80062dd4          // "0P" // 0x80062dd4(0x45, 0x4, 0x0, 0x0)
         a0 = s2 & 0xff
         s0 = v0 & 0xff
         call 0x80062dd4          // 0x80062dd4(0x0, 0x4, 0x0, 0x0)
         a0 = s2 & 0xff
         v1 = 0 + 0x64
         unsigned , hi
         at = 0x437f << 16
    ...
    loc_0x802d82f8: // orphan
         ...
         trunc.w.s f4, f8
         mfc1 t5, f4
         call 0x800495f8          // 0x800495f8(0x161, 0x0, 0x0, 0x88904180)
         [sp + 0x14] = t5
         call 0x80062d98          // 0x80062d98(0x161, 0x0, 0x0, 0x88904180)
         a0 = s2 & 0xff
         a1 = v0 << 0x18
         byte [sp + 0x73] = v0
         a1 = , signed  a1 >> 0x18
         call 0x88000510          // 0x88000510(0x0, 0x0, 0x0, 0x88904180)
         a0 = sp + 0x74
         call 0x880006e0          // 0x880006e0(0x178074, 0x0, 0x0, 0x88904180)
         a0 = v0

    loc_0x802d8364: // orphan
         t6 = 0x8800 << 16
         t6 = [t6 + 0x687c]
         a0 = 0
         a2 = [sp + 0x88]
    ...
    loc_0x802d8384: // orphan
         goto 0x802d8390
         v1 = 0 + 0x13

    loc_0x802d838c: // orphan
         v1 = byte [sp + 0x73]

    loc_0x802d8390: // orphan
         ...
         a3 = v0
         a2 += 0x115
         call 0x80048e30          // 0x80048e30(-1, 0x0, 0x1010a, 0x0)
         a1 = t8 + t9
         a0 = 0 + 0xff
         a1 = 0 + 0xff
         call 0x88002ba0          // 0x88002ba0(0xff, 0xff, 0x1010a, 0x0)
         a2 = 0 + 0xff
         a0 = 0 + 0xef
         call 0x8004d334          // 0x8004d334(0xef, 0xff, 0xff, 0x0)
         a1 = 0
         call 0x8004d40c          // 0x8004d40c(0xef, 0x0, 0xff, 0x0)
         a0 = 0 + 1
         v0 = halfword [s4 + 6]
         v1 = , unsigned  byte [s4 + 0xe]
         s0 = 0x8890 << 16
         s1 = v0 + 0xab
         s1 <<= 0x10
         if                       // likely
    ...
    loc_0x802d8408: // orphan
         s0 += 0x4188

    loc_0x802d840c: // orphan
         t2 = [s4 + 8]
         v0 = t2 + s3
         a0 = , unsigned  byte [v0 + 2]
         beql s6, a0, 0x802d8450  // unlikely
         s3 += 1

    loc_0x802d8420: // orphan
         call 0x80062eb0          // 0x80062eb0(0x0, 0x0, 0x0, 0x0)
         a1 = , unsigned  byte [v0 + 0x18]
         a0 = halfword [s4 + 4]
         t3 = v0 & 0x3f
         [sp + 0x10] = t3
         a1 = s1
         a2 = 0
         a3 = s0
         call 0x8004d5b8          // 0x8004d5b8(0xffff, 0x0, 0x0, 0x0)
         a0 += 0x1ee
         v1 = , unsigned  byte [s4 + 0xe]
         s3 += 1

    loc_0x802d8450: // orphan
         s1 += 0x1a
         s1 <<= 0x10
         at = , unsigned  , s3 < v1
         if                       // unlikely
    ...
    loc_0x802d8464: // orphan
         v0 = halfword [s4 + 6]

    loc_0x802d8468: // orphan
         t5 = halfword [s4 + 0xc]
         t4 = [s4 + 0]
         a1 = halfword [s4 + 4]
         t6 = t5 << 2
         ...
         a2 = , signed  a2 >> 0x10
         a1 = , signed  a1 >> 0x10
         call 0x880009a8          // 0x880009a8(0x80200f2, 0xffff0161, 0xffffd0d9, 0x0)
         a3 = 0 + 0x9d
         ra = [sp + 0x44]
         s0 = [sp + 0x28]
         s1 = [sp + 0x2c]
    ...
    loc_0x802d9d00: // orphan
         ...
         a0 += 8
         v1 = [s4 + 0]
         beql s5, v1, 0x802d9d28  // likely
         v0 = [s0 + 0]

    loc_0x802d9d1c: // orphan
         bnel s6, v1, 0x802d9d60  // unlikely
         t1 = [s3 + 0]
    ...
    loc_0x802d9d34: // orphan
         beql at, 0, 0x802d9d60   // likely
         t1 = [s3 + 0]

    loc_0x802d9d3c: // orphan
         t9 = , unsigned  byte [v0 + 0x26]
         a3 = 0 + 3               // arg4
         t0 = t9 & 1
         bnel t0, 0, 0x802d9d60   // unlikely
         t1 = [s3 + 0]

    loc_0x802d9d50: // orphan
         a0 = byte [s7 + 0]
         call 0x8005e8a0          // 0x8005e8a0(0x0, 0x0, 0x0, 0x0)
    ...
    loc_0x802d9d60: // orphan
         s1 += 1
         s0 += 4
         t2 = , unsigned  byte [t1 + 0x15]
         at = , unsigned  , s1 < t2
         bnel at, 0, 0x802d9d00   // likely
         a0 = [s0 + 0]
    ...
    loc_0x802da534: // orphan
         ...
         a1 = byte [s1 + 0]
         a2 = 0
         call 0x8006218c          // 0x8006218c(0x22, 0x0, 0x0, 0x0)
         a3 = 0
         t2 = [s2 + 0]
         s0 = v0
         a1 = [sp + 0x38]
