...
int fcn.8045664c (int esi, int edx) {
    ...
    loc_0x8045779c: // orphan
         // CODE XREFS from fcn.8045664c @ 0x474, 0x80457768, 0x80457778
         v0 = [sp + 0x24]
         sp += 0x28
         ret                      // ra
    ...
    loc_0x8045968c: // orphan
         ...
         // CODE XREF from fcn.8045664c @ +0x290
         // CODE XREF from fcn.8045664c @ 0x80457b7c
         if                       // likely
         a0 = 0 + 0x1e
